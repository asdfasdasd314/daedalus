        ...
        <div className="agent-chat-scrollbar min-h-0 flex-1 overflow-y-auto p-4 sm:p-5">
          ...
          {selected ? (
            <div className="grid min-w-0 gap-4">
              ...
              {selected.mode === "bridge" ? <section className="grid gap-3 rounded-xl border border-violet-300/20 bg-violet-300/[0.05] p-4"><h3 className="font-semibold text-white">Answer-oriented programming</h3><p className="text-sm text-slate-300">Bridge questions and task dispatch live in the feature-detail AOP tab.</p></section> : null}
