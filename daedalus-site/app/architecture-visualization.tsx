...
export default function ArchitectureVisualization({
  ...
  if (view.status === "failed" && !document) {
    ...
    return <CanvasMessage title={validationExhausted ? "Document validation failed after three attempts" : "Architecture generation failed"} detail={view.error || "No structured document was produced."} tone="error" progressView={view} />;
  }
