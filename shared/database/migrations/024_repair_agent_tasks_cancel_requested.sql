-- Repair skipped 015 application: live schemas may already have conversation_id
-- (021) while still missing agent_tasks.cancel_requested, which breaks every
-- browser select that includes the column (History hydration / task poll).
