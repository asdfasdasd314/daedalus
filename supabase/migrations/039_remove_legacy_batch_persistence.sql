...
-- Historical batch completions may not identify one task. Retain their audit
-- records as generic status events before removing the retired event type.
update daemon_events set event_type = 'status'
where event_type = 'batch_completed';
