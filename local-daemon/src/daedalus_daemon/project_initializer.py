...
PARAMETER_PATH = PROJECT_ROOT / "parameter_files" / "automated-project-initialization.toml"
TEMPLATE_ROOT = Path(__file__).resolve().parents[2] / "templates" / "project-initializer"
